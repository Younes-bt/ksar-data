  ...
  const dataFiles = [
    {
      ...
      url: 'https://res.cloudinary.com/daeuundyc/raw/upload/v1754749965/full_data_v6_wwx7th.json',
      url_csv: '/budget_data.csv',
      url_excel: '/budget_data.xlsx',
      icon: Database,
      size: '~3MB',
    ...
    },
    {
      ...
      url: '/part1_json.json',
      url_csv: '/part1_data.csv',
      url_excel: '/part1_data.xlsx',
      icon: Users,
      size: '~1MB',
      records: '50K+ records'
    },
    {
      ...
      url: '/part2_json.json',
      url_csv: '/part2_data.csv',
      url_excel: '/part2_data.xlsx',
      icon: Users,
      size: '~1MB',
      records: '50K+ records'
    },
